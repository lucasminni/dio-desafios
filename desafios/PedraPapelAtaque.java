...
// TODO: complete os espaços em branco com sua solução para o problema
    	for (int i = 0; i < N; i++) {
    		...
    		if(jogador1.equalsIgnoreCase("ataque") && ! jogador2.equalsIgnoreCase("ataque")) System.out.println("Jogador 1 venceu");
            else if(jogador2.equalsIgnoreCase("ataque") && ! jogador1.equalsIgnoreCase("ataque")) System.out.println("Jogador 2 venceu");
            ...
            else if(jogador2.equalsIgnoreCase("pedra") && jogador2.equalsIgnoreCase("papel")) System.out.println("Jogador 2 venceu");
            else if(jogador1.equalsIgnoreCase("papel") && jogador2.equalsIgnoreCase("papel")) System.out.println("Sem ganhador1");
        }
    }   
}